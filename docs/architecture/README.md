...
| [0010](0010-media-and-embeds.md)                          | Videos: the cover is YouTube's own thumbnail (needs no player), legacy embeds are rescued as links, and playing in place is a click-to-play facade — **proposed, not yet implemented**                                                            |
